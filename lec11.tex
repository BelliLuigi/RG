...
% Text Node
\draw (109,5.5) node [anchor=north west][inner sep=0.75pt]   [align=left] {Flat Spacetime (FST )};
% Text Node
\draw (461.67,5.67) node [anchor=north west][inner sep=0.75pt]   [align=left] {Curved Spacetime (CST)};
% Text Node
...
\[
\frac{d}{d\lambda } \left( T^{\mu _{1} \ldots \mu _{l}}_{\nu _{1}\ldots \nu _{l}} \right) = \frac{d x^{\sigma }}{d \lambda } \partial_{\sigma } \left( T^{\mu _{1}\ldots \mu _{k}}_{\nu _{1}\ldots \nu _{l}} \right) = 0
\]
both notations are equivalent. \par
