...
This is the structure (with all indices suppressed) of the Taylor expansion up to the quadratic term in the new frame of the metric tensor around point $P$. \par
It's true to write:
\[
