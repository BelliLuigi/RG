...
% Text Node
\draw (268.85,22) node [anchor=north west][inner sep=0.75pt]   [align=left] {{ t}};
% Text Node
...
% Text Node
\draw (196,242) node [anchor=north west][inner sep=0.75pt]   [align=left] {{ F}};
% Text Node
\draw (325,164) node [anchor=north west][inner sep=0.75pt]   [align=left] {{ F}};
% Text Node
...
% Text Node
\draw (60,203) node [anchor=north west][inner sep=0.75pt]   [align=left] {{ Light-like}};
% Text Node
