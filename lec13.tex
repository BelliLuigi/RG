...
The exponential map is invertible.\par \bigskip

\begin{tikzpicture}[x=0.5pt,y=0.35pt,yscale=-1,xscale=1]
...
% Text Node
\draw (535,47) node [anchor=north west][inner sep=0.75pt]   [align=left] {{ M}};
% Text Node
\draw (135,152) node [anchor=north west][inner sep=0.75pt]   [align=left] {{ P}};
% Text Node
\draw (260,100) node [anchor=north west][inner sep=0.75pt]   [align=left] {{ Q}};
% Text Node
\draw (170,105) node [anchor=north west][inner sep=0.75pt]   [align=left] {{ k $\in T_{P}$}};
% Text Node
\draw (167,200) node [anchor=north west][inner sep=0.75pt]   [align=left] { $\lambda = 0$};
% Text Node
\draw (278,140) node [anchor=north west][inner sep=0.75pt]   [align=left] { $\lambda = 1$};
% Text Node
\draw (440,115) node [anchor=north west][inner sep=0.75pt]   [align=left] { \emph{geodesic}};
\end{tikzpicture}
...
\subsection{Riemann Curvature Tensor} \label{sec:Rtns}
